...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.architecturaltemplates.Completion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompletionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addCompletionFileURIPropertyDescriptor(object);
		}
	 ...
	 * @generated
	 */
	protected void addCompletionFileURIPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Completion_completionFileURI_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_Completion_completionFileURI_feature",
						"_UI_Completion_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArchitecturaltemplatesPackage.Literals.COMPLETION__PARAMETERS);
		}
	...
	public String getText(Object object) {
		String label = ((Completion) object).getCompletionFileURI();
		return label == null || label.length() == 0 ? getString("_UI_Completion_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ArchitecturaltemplatesPackage.Literals.COMPLETION__PARAMETERS,
				ArchitecturaltemplatesFactory.eINSTANCE.createPCMBlackboardCompletionParameter()));

		newChildDescriptors.add(createChildParameter(ArchitecturaltemplatesPackage.Literals.COMPLETION__PARAMETERS,
				ArchitecturaltemplatesFactory.eINSTANCE.createPCMTemplateCompletionParameter()));
