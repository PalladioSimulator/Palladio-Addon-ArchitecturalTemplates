...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.architecturaltemplates.OCLConstraint} object.
 * <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * @generated
 */
public class OCLConstraintItemProvider extends ConstraintItemProvider {
	...
	public String getText(Object object) {
		String label = ((OCLConstraint) object).getEntityName();
		return label == null || label.length() == 0 ? getString("_UI_OCLConstraint_type")
