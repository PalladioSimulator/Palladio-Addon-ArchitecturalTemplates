...
public class PCMTemplateCompletionParameterItemProvider extends PCMCompletionParameterItemProvider {
	 ...
	 * @generated
	 */
	public PCMTemplateCompletionParameterItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addTemplateFileURIPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_PCMTemplateCompletionParameter_templateFileURI_feature"),
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PCMTemplateCompletionParameter"));
	}
	...
	public String getText(Object object) {
		String label = ((PCMTemplateCompletionParameter) object).getTemplateFileURI();
		return label == null || label.length() == 0 ? getString("_UI_PCMTemplateCompletionParameter_type")
