...
public class GenericFileExtensionItemProvider extends FileExtensionItemProvider {
	 ...
	 * @generated
	 */
	public GenericFileExtensionItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addFileExtensionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_GenericFileExtension_fileExtension_feature"),
						getString("_UI_PropertyDescriptor_description",
								"_UI_GenericFileExtension_fileExtension_feature", "_UI_GenericFileExtension_type"),
						ArchitecturaltemplatesPackage.Literals.GENERIC_FILE_EXTENSION__FILE_EXTENSION, true, false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GenericFileExtension"));
	}
	...
	public String getText(Object object) {
		String label = ((GenericFileExtension) object).getFileExtension();
		return label == null || label.length() == 0 ? getString("_UI_GenericFileExtension_type")
				: getString("_UI_GenericFileExtension_type") + " " + label;
	}
