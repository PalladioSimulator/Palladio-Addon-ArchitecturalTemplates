 ...
 *
 * <!-- begin-model-doc -->
 * An AT is a template representing and documenting reusable architectural knowledge. Software architects can apply ATs for both architectural modeling and architectural analyses while AT engineers specify ATs. An optional default AT instance provides software architects with an initial architectural model corresponding to the represented architectural knowledge, e.g., a reference architecture.
 * 
 * <!-- end-model-doc -->
 *
 * <p>
 ...
 *   <li>{@link org.palladiosimulator.architecturaltemplates.AT#getReconfigurationRuleFolder <em>Reconfiguration Rule Folder</em>}</li>
 *   <li>{@link org.palladiosimulator.architecturaltemplates.AT#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link org.palladiosimulator.architecturaltemplates.AT#getDefaultInstanceURI <em>Default Instance URI</em>}</li>
 *   <li>{@link org.palladiosimulator.architecturaltemplates.AT#getDependencies <em>Dependencies</em>}</li>
 * </ul>
 *
...
public interface AT extends Entity {
	 ...
	 * It is bidirectional and its opposite is '{@link org.palladiosimulator.architecturaltemplates.Catalog#getATs <em>ATs</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link org.palladiosimulator.architecturaltemplates.AT#getCatalog <em>Catalog</em>}' container reference.
	...
	/**
	 * Sets the value of the '{@link org.palladiosimulator.architecturaltemplates.AT#getReconfigurationRuleFolder <em>Reconfiguration Rule Folder</em>}' containment reference.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * @param value the new value of the '<em>Reconfiguration Rule Folder</em>' containment reference.
	...
	/**
	 * Sets the value of the '{@link org.palladiosimulator.architecturaltemplates.AT#getDocumentation <em>Documentation</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link org.palladiosimulator.architecturaltemplates.AT#getDefaultInstanceURI <em>Default Instance URI</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @param value the new value of the '<em>Default Instance URI</em>' attribute.
