...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>PCM Output Completion
 * Parameter</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.palladiosimulator.architecturaltemplates.impl.PCMOutputCompletionParameterImpl#getFileExtension
...
public class PCMOutputCompletionParameterImpl extends CompletionParameterImpl implements PCMOutputCompletionParameter {
    ...
    public PCMFileExtensions getFileExtension() {
        return (PCMFileExtensions) this.eDynamicGet(
                ArchitecturaltemplatesPackage.PCM_OUTPUT_COMPLETION_PARAMETER__FILE_EXTENSION,
                ArchitecturaltemplatesPackage.Literals.PCM_OUTPUT_COMPLETION_PARAMETER__FILE_EXTENSION, true, true);
    }
    ...
    public void setFileExtension(final PCMFileExtensions newFileExtension) {
        this.eDynamicSet(ArchitecturaltemplatesPackage.PCM_OUTPUT_COMPLETION_PARAMETER__FILE_EXTENSION,
                ArchitecturaltemplatesPackage.Literals.PCM_OUTPUT_COMPLETION_PARAMETER__FILE_EXTENSION,
                newFileExtension);
    }
